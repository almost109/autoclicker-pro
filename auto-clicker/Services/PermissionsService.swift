...
final class PermissionsService: ObservableObject {
    ...
    func refreshAccessibilityPrivileges(
        ...
        if !isCurrentlyTrusted,
           self.isTrusted,
           let confirmation {
            self.scheduleRevocationConfirmation(confirmation)
            return true
        }

        self.cancelRevocationConfirmation()
    ...
    private func scheduleRevocationConfirmation(_ confirmation: @escaping () -> Void) {
